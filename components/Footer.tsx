    ...
    <>
      <Head>
        <script
          ...
          src="https://cdn.capp.bka.sh/scripts/webview_bridge.js"
          async
        />
      </Head>
      ...
      <div className={`text-center fixed-bottom ${styles.bottomNav}`}>
        <div className="row mt-3">
          <div className="col">
            <Link
              className={`${
                router.pathname === "/[index_token]" || router.pathname === "/"
                  ? styles.activeMenu
                  : styles.inActiveMenu
              }`}
              href="/"
          ...
          <div className="col">
            <Link
              ...
              href="/library"
            >
              <MdOutlineLibraryMusic style={{ fontSize: "24px" }} />{" "}
              {router.pathname === "/library" ? (
                <p className="mb-0" style={{ fontSize: "12px" }}>
                  Library
                </p>
        ...
        <div className="row">
          {router.pathname === "/[index_token]" || router.pathname === "/" ? (
            ...
            <button
              ...
              type="button"
              onClick={() =>
                window.webViewJSBridge?.goBackHome("Wonder Soft Solution")
              }
              style={{
                left: "0",
                bottom: "0",
            ...
            >
              ...
              <picture>
                <img
                  src="https://cdn.capp.bka.sh/images/arrow.svg"
                  style={{
                    float: "right",
                    marginTop: "4px",
                    paddingRight: "1%",
